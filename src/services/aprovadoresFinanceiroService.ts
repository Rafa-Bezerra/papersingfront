...
const caminho = "AprovadoresFinanceiro";
const elemento_singular = "aprovador";
const elemento_plural = "aprovadores";

export async function getAll(): Promise<AprovadoresFinanceiro[]> {
    ...
    const list: AprovadoresFinanceiro[] = await res.json();
    return list;
}

export async function getElementById(id: number): Promise<AprovadoresFinanceiro> {
    ...
    const apiData: AprovadoresFinanceiro = await res.json();
    return apiData;
}

export async function createElement(data: AprovadoresFinanceiro): Promise<void> {
...
export async function updateElement(data: AprovadoresFinanceiro): Promise<void> {
...
export type { AprovadoresFinanceiro }
