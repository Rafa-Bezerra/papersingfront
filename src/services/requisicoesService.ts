...
export async function getAll(dateFrom: string, dateTo: string, movimentos: string[], situacao: string, restrito: string, situacaoEntrega: string = "", apenasComNF: boolean = false): Promise<RequisicaoDto[]> {
