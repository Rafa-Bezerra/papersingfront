import { AprovadoresImpostos } from "@/types/AprovadoresImpostos";
import { API_BASE, headers } from "@/utils/constants";
const caminho = "AprovadoresImpostos";
const elemento_singular = "aprovador";
const elemento_plural = "aprovadores";

export async function getAll(): Promise<AprovadoresImpostos[]> {
    ...
    const list: AprovadoresImpostos[] = await res.json();
    return list;
}

export async function getElementById(id: number): Promise<AprovadoresImpostos> {
    ...
    const apiData: AprovadoresImpostos = await res.json();
    return apiData;
}

export async function createElement(data: AprovadoresImpostos): Promise<void> {
...
export async function updateElement(data: AprovadoresImpostos): Promise<void> {
...
export type { AprovadoresImpostos }