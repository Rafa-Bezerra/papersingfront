                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex gap-2">
                            ...
                            {requisicao.status_movimento?.startsWith('Concluído') && requisicao.codigo_fornecedor && requisicao.codigo_fornecedor !== 'EM_COTACAO' && !requisicao.contrato_gerado && (requisicao.contrato_solicitado || userAdmin) && userContratos && TIPOS_MOVIMENTO_CONTRATO.includes(requisicao.tipo_movimento) && (
                                <Button
                                    size="sm"
                                    variant="outline"
