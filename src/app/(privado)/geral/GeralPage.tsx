...
export default function Page() {
    ...
    async function handleSearch(q: string) {
        ...
        try {
            ...
            const dados = await getAllRequisicoes(fromApi, to, [], situacaoFiltrada, "", entregaFiltrada, apenasComNF);
        ...
        <div className="p-6">
            ...
            {requisicaoSelecionada && (
                <Dialog open={isModalAnexosOpen} onOpenChange={setIsModalAnexosOpen}>
                    <DialogContent className="sm:max-w-[90vw] overflow-y-auto max-h-[90dvh]">
                        <DialogHeader>
            ...
            <PdfViewerDialog
                ...
                title={anexoSelecionado ? `Anexo n° ${anexoSelecionado.id} - ${anexoSelecionado.nome} (${currentAnexoIndex + 1}/${anexos.length})` : ''}
